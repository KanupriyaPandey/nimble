...
import com.projects.android.MyNotes.activity.ImageActivity;
import com.projects.android.MyNotes.adapter.ThumbnailsAdapter;
    ...
    public void prepareThumbnail(final Bitmap bitmap) {
        Runnable r = new Runnable() {
            public void run() {
                ...
                if (bitmap == null) {
                    thumbImage = BitmapUtils.getBitmapFromAssets(getActivity(), ImageActivity.IMAGE_NAME, 100, 100);
                } else {
